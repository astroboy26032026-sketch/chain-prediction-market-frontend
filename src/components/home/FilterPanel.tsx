...
const FilterPanel: React.FC<FilterPanelProps> = ({ pending, setPending, onApply, onClear }) => {
  return (
    <div className="absolute top-10 right-0 z-40 w-[calc(100vw-2rem)] sm:w-[420px] rounded-2xl border border-[var(--card-border)] bg-[var(--background)] text-[var(--foreground)] p-5 shadow-[0_8px_32px_rgba(0,0,0,0.4)]">
      {/* Mcap */}
      <div className="mb-6">
